...
Version  : 1.13.1
Release  : 17
URL      : http://tarballs.openstack.org/os-client-config/os-client-config-1.13.1.tar.gz
Source0  : http://tarballs.openstack.org/os-client-config/os-client-config-1.13.1.tar.gz
...
%prep
%setup -q -n os-client-config-1.13.1
%patch1 -p1
